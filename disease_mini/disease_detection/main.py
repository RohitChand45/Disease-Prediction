...
df=pd.read_csv(r"C:\Users\ASUS\OneDrive\Desktop\disease_mini\disease_detection\Testing.csv")
...
X= df[l1]        #symptom columns.

y = df[["prognosis"]]       
np.ravel(y)      


tr=pd.read_csv(r"C:\Users\ASUS\OneDrive\Desktop\disease_mini\disease_detection\Training.csv")
...
#Get Symptoms from GUI and Predict Disease
    psymptoms = [Symptom1.get(),Symptom2.get(),Symptom3.get(),Symptom4.get(),Symptom5.get()]   #stored
...
#created the labels for the input and output fields
...
# Entry widget for the patient's name, linked to the Name variable.
...
root.mainloop()  # Starts the Tkinter event loop, which waits for user interaction and updates the GUI accordingly.
